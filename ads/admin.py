...
from .models import Author, Ads, Category, AdsImages, AdsTopBanner, AdsRightBanner, AdsBottomBanner
...
class AdsAdmin(admin.ModelAdmin):
    ...
    list_display = ('id', 'title', 'prize', 'author', 'category', 'date_created', 'is_featured', 'is_active')
